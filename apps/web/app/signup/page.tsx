...
<div className="signup-page">
    ...
    <div className="signup-body">
        <div className="signup-card">
            ...
            <p className="card-subtitle">join Form Logic Labs</p>

              <form onSubmit={handleSubmit}>
                <div className="form-fields">
                    <label htmlFor="name" className="form-label">your name</label>
                    <input type="text" name="name" id="name" placeholder="enter your name" required className="form-input" />
                </div>
                ...
                <button className="submit-btn" type="submit" disabled={signupMutation.isPending}>
